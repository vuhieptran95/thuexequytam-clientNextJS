...
// CONCATENATED MODULE: ./helper/UpdateRemoveArray.jsx
var UpdateRemoveArray = function UpdateRemoveArray(array, data) {
  var editedArray = array.filter(function (et) {
    return et != null;
  });

  if (editedArray.includes(data)) {
    editedArray = editedArray.filter(function (et) {
      return et != data;
    });
  } else {
...
// CONCATENATED MODULE: ./shared/HOCs/EditTypesHOCs.jsx
...
var WithEditTypes = Object(external_recompose_["withState"])("editTypes", "updateEditTypes", []);
var WithDeletedType = Object(external_recompose_["withState"])("deletedType", "updateDeletedType", "");
var WithEditedTypes = Object(external_recompose_["withState"])("editedTypes", "updateEditedTypes", []);
var WithAddNewTypes = Object(external_recompose_["withState"])("addNewTypes", "updateAddNewTypes", []);
var WithEditTypesHandlers = Object(external_recompose_["withHandlers"])({
  handleSaveType: function handleSaveType(props) {
    return (
      /*#__PURE__*/
      function () {
        ...
        regenerator_default.a.mark(function _callee(event) {
          var typeId, typeName, defaultValue, editedTypes;
          return regenerator_default.a.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  typeId = event.target.value;
                  typeName = document.getElementById(typeId).value;
                  ...
                  _context.next = 5;
                  return FirebaseConfig["a" /* default */].collection("types").doc(typeId).update({
                    name: typeName
                  });
                ...
                case 5:
                  ...
                  editedTypes = UpdateRemoveArray(props.editedTypes, typeId);
  ...
  handleDeleteType: function handleDeleteType(props) {
    return function (event) {
      var typeId = event.target.value;
      event.preventDefault();
      if (window.confirm("Muốn xóa thật không?")) FirebaseConfig["a" /* default */].collection("types").doc(typeId).delete();
    };
  },
  handleCreateNewType: function handleCreateNewType(props) {
    return function (event) {
      var typeId = event.target.value;
      var type = props.addNewTypes.find(function (t) {
        return t.id == typeId;
      });
      var typeName = document.getElementById(typeId).value;
      var newTypeId = typeName + Date.now();
      FirebaseConfig["a" /* default */].collection("types").doc(newTypeId).set({
        id: newTypeId,
        name: typeName,
        order: Default_default.a.TypeOrder
      });
      var addNewTypes = UpdateRemoveArray(props.addNewTypes, type);
      props.updateAddNewTypes(addNewTypes);
    };
  },
  handleSelectEditedType: function handleSelectEditedType(props) {
    return function (event) {
      var editedTypes = UpdateRemoveArray(props.editedTypes, event.target.value);
      props.updateEditedTypes(editedTypes);
    };
  },
  handleAddNewType: function handleAddNewType(props) {
    return function (event) {
      var type = {
        id: Date.now(),
        name: "Tên loại xe mới"
      };
      var addNewTypes = props.addNewTypes.filter(function (nt) {
        return nt != null;
      });
  ...
  handleCancleAddNewType: function handleCancleAddNewType(props) {
    return function (event) {
      var addNewTypes = props.addNewTypes.filter(function (nt) {
        return nt.id != event.target.value;
      });
      props.updateAddNewTypes(addNewTypes);
    };
  }
});
var EditTypesLifeCycle = Object(external_recompose_["lifecycle"])({
  componentDidMount: function componentDidMount() {
    var _this = this;
    ...
    FirebaseConfig["a" /* default */].collection("types").onSnapshot(function (docs) {
      ...
      docs.forEach(function (doc) {
        types.push(_objectSpread({
          id: doc.id
        }, doc.data()));
      });

      _this.props.updateEditTypes(types);
    });
  }
});
// CONCATENATED MODULE: ./pages/admin/manage-cars/edit-types.jsx




var enhance = Object(external_recompose_["compose"])(WithEditTypes, WithEditedTypes, WithDeletedType, WithAddNewTypes, WithEditTypesHandlers, EditTypesLifeCycle);

var edit_types_EditTypes = function EditTypes(_ref) {
  var editTypes = _ref.editTypes,
      editedTypes = _ref.editedTypes,
      deletedType = _ref.deletedType,
      addNewTypes = _ref.addNewTypes,
      handleSelectEditedType = _ref.handleSelectEditedType,
      handleSaveType = _ref.handleSaveType,
      handleAddNewType = _ref.handleAddNewType,
      handleCancleAddNewType = _ref.handleCancleAddNewType,
      handleCreateNewType = _ref.handleCreateNewType,
      handleDeleteType = _ref.handleDeleteType;
  return external_react_default.a.createElement(ManageCarsLayout["a" /* default */], null, external_react_default.a.createElement("div", {
    ...
    className: "row"
  }, external_react_default.a.createElement("h3", null, "This is Edit type page")), external_react_default.a.createElement("div", {
    className: "row mb-4"
  }, external_react_default.a.createElement("div", {
    className: "col-lg-2"
  ...
  }, "Th\xEAm m\u1EDBi"))), editTypes.map(function (type) {
    return external_react_default.a.createElement("div", {
      key: type.id
    }, external_react_default.a.createElement("div", {
      hidden: editedTypes.includes(type.id),
      className: "row mb-4"
    }, external_react_default.a.createElement("div", {
    ...
    }, "X\xF3a")), external_react_default.a.createElement("div", {
      ...
      onClick: handleSelectEditedType,
      value: type.id,
      className: "btn btn-warning btn-block"
    }, "S\u1EEDa"))), external_react_default.a.createElement("div", {
      hidden: !editedTypes.includes(type.id.toString()),
      className: "row mb-4"
    }, external_react_default.a.createElement("div", {
      className: "col-lg-1 col-3"
    }, external_react_default.a.createElement("button", {
    ...
    return external_react_default.a.createElement("div", {
      ...
      onClick: handleCancleAddNewType,
      value: type.id,
      className: "btn btn-secondary btn-block"
    }, "X")), external_react_default.a.createElement("div", {
      className: "col-lg-3 col-6"
...
/* harmony default export */ var edit_types = __webpack_exports__["default"] = (enhance(edit_types_EditTypes));
